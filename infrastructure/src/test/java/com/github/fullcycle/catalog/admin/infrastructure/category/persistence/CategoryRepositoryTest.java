...
public class CategoryRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.github.fullcycle.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.name";
    ...
    public void givenAnInvalidNullCreatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.github.fullcycle.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
    ...
    public void givenAnInvalidNullUpdatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.github.fullcycle.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
