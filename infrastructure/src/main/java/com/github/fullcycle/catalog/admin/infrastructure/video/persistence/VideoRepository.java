package com.github.fullcycle.catalog.admin.infrastructure.video.persistence;

import com.github.fullcycle.catalog.admin.domain.video.VideoPreview;
...
public interface VideoRepository extends JpaRepository<VideoJpaEntity, String> {
    ...
    @Query("""
            select distinct new com.github.fullcycle.catalog.admin.domain.video.VideoPreview(
                v.id as id,
                v.title as title,
